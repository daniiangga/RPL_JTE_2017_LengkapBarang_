...
<div class="column fivecol">
	...
	<span class="secondary"><?php _e('Toko yang anda cari tidak ada', 'makery'); ?></span>
	<?php } else if(ThemexShop::$data['status']=='pending') { ?>
	<span class="secondary"><?php _e('Toko ini sedang di nilai', 'makery'); ?></span>
	<?php } else { ?>
	...
	<?php } ?>
		...
		// ini merupakan kode untuk aturan toko
		<div class="profile-editor">
		...
		<?php if(ThemexShop::$data['status']=='draft') { ?>
			...
			<?php } else { ?>
			<a href="#" class="element-button element-submit primary"><?php _e('Masukkan', 'makery'); ?></a>
			<?php } ?>		
		<?php } else { ?>
		<a href="#" class="element-button element-submit primary"><?php _e('Simpan', 'makery'); ?></a>
		...
		<div id="remove_form">
			<div class="site-popup small">
				<form class="site-form" method="POST" action="">
					<p><?php _e('Anda yakin ingin menghapus toko ini secara permanen?', 'makery'); ?></p>
					<a href="#" class="element-button element-submit primary"><?php _e('Hapus Tokonya', 'makery'); ?></a>
					<input type="hidden" name="shop_id" value="<?php echo ThemexShop::$data['ID']; ?>" />
